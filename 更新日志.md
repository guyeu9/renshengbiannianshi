...
- **模块管理标签统计修复**：
  - **根因**：模块管理页面的标签统计仅统计配置中已存在的标签，无法发现数据库中实际存在但配置中未定义的标签；小确幸标签统计仅读取 `sceneTag` 单值字段，不支持 JSON 数组格式
  - **解决**：
  ...
  - **变动文件**：[profile_page.dart](file:///d:/trae/%E4%BA%BA%E7%94%9F%E7%BC%96%E5%B9%B4%E5%9B%BD%E9%99%85/life_chronicle/lib/features/profile/presentation/profile_page.dart)
