...
class FilterOptionChip extends StatelessWidget {
  const FilterOptionChip({super.key, required this.label, required this.selected, required this.onTap});
...
// 筛选朋友列表项
class FilterFriendTile extends StatelessWidget {
  const FilterFriendTile({super.key, required this.name, required this.imagePath, required this.checked, required this.onTap});
...
// 选择项数据类
class SelectItem {
  const SelectItem({required this.id, required this.title, required this.leading});
...
class MultiSelectBottomSheet extends StatefulWidget {
  const MultiSelectBottomSheet({super.key, required this.title, required this.items, required this.initialSelected});
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(widget.title, textAlign: TextAlign.center, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: Color(0xFF111827))),
                    ),
                    TextButton(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: Text(item.title, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFF111827)))),
                            Icon(checked ? Icons.check_circle : Icons.radio_button_unchecked, color: checked ? const Color(0xFF2BCDEE) : const Color(0xFFCBD5E1)),
                          ],
                        ),
                      ),
